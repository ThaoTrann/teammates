...
public class StudentsLogicTest extends BaseLogicTest {
    ...
    public void testAll() throws Exception {
        ...
        getStudentsWhoCanViewSession();
        getStudentsWithUnansweredQuestions();
    ...
    private void getStudentsWhoCanViewSession() {
        List<StudentAttributes> expectedStudentList;
        List<StudentAttributes> actualStudentList;
        FeedbackSessionAttributes session;
    ...
    private void getStudentsWithUnansweredQuestions() throws Exception {
        List<StudentAttributes> expectedStudentList;
        List<StudentAttributes> actualStudentList;
        FeedbackSessionAttributes session;
